...
def notes():
    ...
    def addnotes():
        try:
            ...
            con = pm.connect(host="localhost", database='Notespro', user='root', password='Ashitta@2005')
            cursor = con.cursor()
...
def get_connection():
    return pm.connect(host="localhost", database="Notespro", user="root", password="Ashitta@2005")
